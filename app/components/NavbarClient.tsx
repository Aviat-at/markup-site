              ...
              <>
                ...
                <div className="topics-popover" role="menu">
                  {categories.map((category) => {
                    ...
                    return (
                      <Link href={`/${category}`} key={category} role="menuitem" onClick={() => setTopicsOpen(false)}>
                        <meta.icon size={16} />
                        <span>
        ...
        <div className="mobile-menu" ref={mobileRef}>
          ...
          {mobileOpen && (
            <nav>
              ...
              {categories.map((category) => (
                <Link href={`/${category}`} key={category} onClick={() => setMobileOpen(false)}>{getCategoryMeta(category).label}</Link>
              ))}
